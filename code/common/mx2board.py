...
PERIPHERALS = \
    {
        ...
        "USART1": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 7)],
        "USART3": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 7)],
