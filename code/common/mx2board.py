...
PERIPHERALS = \
    {
        ...
        "(RCC|SYS)_OSC": [PIN_MODE_INPUT, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 0)],
        "ADC[x1-4]": [PIN_MODE_ANALOG, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                PIN_AFIO_AF.format("{0}", 0)],
        "DAC": [PIN_MODE_ANALOG, PIN_OTYPE_PUSHPULL, PIN_OSPEED_2M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                PIN_AFIO_AF.format("{0}", 0)],
        "CAN_TX": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 9)],
        "CAN_RX": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 9)],
        "TIM2_CH[34]": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
        ...
        "TIM4_CH[1-4]": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                    PIN_AFIO_AF.format("{0}", 2)],
        "USART[1-3]_TX": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_PULLUP, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 7)],
        "USART[1-3]_RX": [PIN_MODE_ALTERNATE, PIN_OTYPE_OPENDRAIN, PIN_OSPEED_50M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                   PIN_AFIO_AF.format("{0}", 7)],
        "USB": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_100M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
                PIN_AFIO_AF.format("{0}", 14)],
        "SPI[12]_": [PIN_MODE_ALTERNATE, PIN_OTYPE_PUSHPULL, PIN_OSPEED_100M, PIN_PUPDR_FLOATING, PIN_ODR_HIGH,
