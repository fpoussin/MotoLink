...
const pb_field_t FlashWriteRequest_fields[4] = {
...
const pb_field_t FlashReadRequest_fields[4] = {
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(FlashWriteRequest, header) < 65536 && pb_membersize(FlashReadRequest, header) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_FlashWriteRequest_FlashReadRequest)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(FlashWriteRequest, header) < 256 && pb_membersize(FlashReadRequest, header) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_FlashWriteRequest_FlashReadRequest)
#endif
