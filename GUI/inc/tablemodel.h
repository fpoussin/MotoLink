...
class TableModel : public QStandardItemModel {
  Q_OBJECT
public:
  explicit TableModel(QUndoStack *stack, int min = -30, int max = 30,
                      int def = 0, bool singlerow = false,
                      bool permanent = true, QObject *parent = 0);
  ~TableModel(void);
...
private:
  QColor NumberToColor(float value, bool greenIsNegative = true,
                       bool darkColor = true);
